"""
    ...
    Simple function to perturb the surface temperature in LES mode 
    and create a turbulent boundary layer
...
print(surface_T.shape)
print(np.min(surface_T), np.max(surface_T))
print(np.max(surface_T) - np.min(surface_T))
